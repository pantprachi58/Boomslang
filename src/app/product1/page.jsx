...
export const metadata = {
  title: "STRYCNNINE – Herbal Weight Gain Capsules | Boomslang Nutrition",
  description:"STRYCNNINE by Boomslang Nutrition is a carefully formulated Ayurvedic supplement featuring Herbal Weight Gain Capsules designed to support healthy and natural weight gain. Created for individuals looking to improve body nourishment, appetite, strength, stamina, and overall wellness, these Weight Gain Capsules help complement your daily nutrition and fitness routine. If you're searching for the Best Weight Gain Capsules with an Ayurvedic herbal approach, STRYCNNINE offers a thoughtfully crafted formula to support your wellness goals. For optimal results, use it alongside a balanced diet and regular exercise."
    };
...
const product = {
  ...
  description:
    "STRYCNNINE by Boomslang Nutrition is a carefully formulated Ayurvedic supplement featuring Herbal extracts that work in harmony with your body to support healthy weight gain, improved appetite, strength and overall wellness — without steroids or synthetic hormones.",
  discountLabel: "20% Off",
  oldPrice: 999,
  price: 799,
  flavours: [
    { id: "Blood Orange", name: "Blood Orange", available: true },
    { id: "Mango", name: "Mango", available: true },
    { id: "Pineapple", name: "Pineapple", available: true },
    { id: "Mix Fruit", name: "Mix Fruit", available: false },
  ],
  weights: [
    { id: "500g", name: "500g", price: 799, oldPrice: 999 },
    { id: "1kg", name: "1kg", price: 1499, oldPrice: 1899 },
    { id: "2kg", name: "2kg", price: 2799, oldPrice: 3499 },
  ],
  images: [
    "/images/goku-gainz-three-bottles.png",
    "/images/goku-gainz-lifestyle-collage.png",
    "/images/strycnnine-Pineapple.png",
  ...
  disclaimer:
    "STRYCNNINE Herbal Weight Gain Capsules are an Ayurvedic dietary supplement and should not be considered a medicine. This product is not intended to diagnose, treat, cure, or prevent any disease. Individual results may vary based on body type, dietary habits, lifestyle, and consistency of use.",
};
